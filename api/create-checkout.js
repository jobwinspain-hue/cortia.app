export default async function handler(req, res) {
  ...
  const PLANES = {
    basico: { precio: 3490, nombre: 'CortIA Básico', descripcion: '200 generaciones de peinados al mes' },
    pro:    { precio: 6490, nombre: 'CortIA Pro',    descripcion: '500 generaciones de peinados al mes' },
    premium:{ precio: 15990, nombre: 'CortIA Premium',descripcion: '1.500 generaciones de peinados al mes' },
  };
  try {
    ...
    const baseUrl = `https://cortialooks.com`;
